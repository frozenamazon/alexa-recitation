"use strict";
var APP_ID = "amzn1.ask.skill.024b05c9-7e7f-4217-a583-0c062062f110";  // TODO replace with your app ID (OPTIONAL).

var ANSWER_COUNT = 4; // The number of possible answers per trivia question.
var GAME_LENGTH = 100;  // The number of questions per trivia game.
var GAME_STATES = {
...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Recite math table", // Be sure to change this for your skill.
            "HELP_MESSAGE": "I will recite the multiplication table. Respond with the number of the multiple . " +
            "For example, say one, two, three, or four. To start a new game at any time, say, start game. ",
            "REPEAT_QUESTION_MESSAGE": "To repeat the last question, say, repeat. ",
            "ASK_MESSAGE_START": "Would you like to start playing?",
            "HELP_REPROMPT": "To give an answer to a question, respond with the number of the multiple. ",
            "STOP_MESSAGE": "Would you like to keep playing?",
            "CANCEL_MESSAGE": "Ok, let\'s play again soon.",
            "NO_MESSAGE": "Ok, we\'ll play another time. Goodbye!",
            "TRIVIA_UNHANDLED": "Try saying a number between 1 and %s",
            "HELP_UNHANDLED": "Say yes to continue, or no to end the recitation.",
            "START_UNHANDLED": "Say start to start a new game.",
            "NEW_GAME_MESSAGE": "Welcome to %s. ",
            "WELCOME_MESSAGE": "Tell me a number and I would recite the multiples of the number. " +
            "Just say the number. Let\'s begin. ",
